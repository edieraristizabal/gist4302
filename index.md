...
| --- | ----------- | -------------- | -------- | --------------------- |
|1    |Aug 30, Sept 1 |[Overview of the course](blob/lectures/lecture1.pdf); [Introduction to spatial analysis](blob/lectures/lecture2.pdf)| O'S & U ch.1; [map projection](blob/handouts/projections.pdf)| Review of map projection and ArcGIS | 
