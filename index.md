...
| --- | ----------- | -------------- | -------- | --------------------- |
|1    |Aug 30, Sept 1 |[Overview of the course](blob/lectures/lecture1.pdf); [Introduction to spatial analysis](blob/lectures/lecture1.pdf)| O'S & U ch.1   | Review of map projection and ArcGIS | 
